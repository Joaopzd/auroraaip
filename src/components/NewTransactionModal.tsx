...
import { ArrowDownCircle, ArrowUpCircle, Layers, Plus, X } from "lucide-react";
...
export function NewTransactionModal({ cards, categories, onClose }: { cards: Card[]; categories: string[]; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 p-0 sm:items-center sm:p-4" onClick={onClose}>
      <form
        ...
        className="max-h-[90vh] w-full max-w-md space-y-4 overflow-y-auto rounded-t-3xl bg-surface p-5 ring-1 ring-border sm:rounded-3xl"
      >
